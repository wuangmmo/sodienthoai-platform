...
func requestIP(r *http.Request) string { if x:=strings.TrimSpace(strings.Split(r.Header.Get("X-Forwarded-For"),",")[0]);x!=""{return x};return strings.Split(r.RemoteAddr,":")[0] }
